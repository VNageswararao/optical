                                    ...
                                    <div class="card-body">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item" style="display: none;">
                                                <a class="nav-link" id="base-tab3" data-toggle="tab" aria-controls="tab3" href="#tab3" aria-expanded="false">Supplier Payment Tracking</a>
                                            </li>
                             ...
                             <form id="summaryr" action="#" method="post"> 
                                ...
                                <div class="row">
                                       <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">From Date: <span class="text-danger">*</span></label>
                                            <input type="date" name="sum_fromdater" id="sum_fromdater" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">To Date: <span class="text-danger">*</span></label>
                                            <input type="date" name="sum_todater" id="sum_todater" class="form-control">
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Supplier Name: </label>
                                            <select class="form-control select2" name="sum_supplierr" id="sum_supplierr">
                                                <option value>Select Supplier Name</option>
                                                <?php if($getsupplier)
                                                {
                                                  foreach ($getsupplier as $data) {
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Modeofpay: </label>
                                            <select class="form-control select2" name="sum_modeofpayr" id="sum_modeofpayr">
                                                <option value>Select Modeofpay</option>
                                                <?php if($getmodeofpay)
                                                {
                                                  foreach ($getmodeofpay as $data) {
...
$.fn.dataTable.ext.errMode = 'none';
        $("#overlay").fadeIn(300);
        saveurl="Purchase_return_report/getsummary";
         $.ajax({
            type: "POST",
            url: saveurl,
            dataType: "json",
...
function getsummaryr()
    { 
        if($("#sum_fromdater").val()=='' || $("#sum_todater").val()=='') {
           Swal.fire({title:"Info!",text:"Please Enter  All Mandatory fields !",type:"info",confirmButtonClass:"btn btn-primary",buttonsStyling:!1})
           return false;
        }
        $('#showdata_sumr').html('');
$.fn.dataTable.ext.errMode = 'none';
        $("#overlay").fadeIn(300);
        saveurl="Purchase_return_report/getsummaryr";
         $.ajax({
            type: "POST",
            url: saveurl,
            dataType: "json",
...
$.fn.dataTable.ext.errMode = 'none';
        $("#overlay").fadeIn(300);
        saveurl="Purchase_return_report/getdetailed";
         $.ajax({
            type: "POST",
            url: saveurl,
            dataType: "json",
