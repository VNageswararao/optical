                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Frame Size</h4>
                                </div>
                                <div class="card-content">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Frame Size</a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <div class="tab-content px-1 pt-1">
                                            <div role="tabpanel" class="tab-pane active" id="tab1" aria-expanded="true" aria-labelledby="base-tab1">
                                              <form id="frame" action="#" method="post"> 
                                <input type="hidden" name="csrf_test_name" id="csrf_test_name" value="<?php echo $this->security->get_csrf_hash(); ?>"> 
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="lastname">Code: <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" readonly name="code" placeholder="Code" id="code" value="<?php print $codeno; ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <label for="lastname">Size: <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" placeholder="Size" id="name" name="name" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer ml-auto">
                                    <button type="button" class="btn btn-success btn-min-width btn-glow mr-1 mb-1" onclick="frameclassification('4');">Submit</button>
                                     <button type="button" class="btn btn-info btn-min-width btn-glow mr-1 mb-1" onclick="this.form.reset();">Reset</button>
                                            ...
                                            <div class="tab-pane" id="tab2" aria-labelledby="base-tab2">
                                                 <div class="card-body collapse show">
                                                     <form id="edit_frame" action="#" method="post"> 
 <div id="frame_modal" class="modal fade" role="dialog">
        ...
        <!-- Modal content-->
            <div class="modal-content">
                        ...
                        <div class="col-lg-12 col-md-12" id="div_modal">
                                 <div class="row col-md-12">
                                   <div class="col-md-12 form-group">
                                         <label for="lastname">Code: <span class="text-danger">*</span></label>
                                         <input type="hidden" name="edit_frameid" id="edit_frameid">
                                         ...
                                         <input type="text" name="edit_code" readonly id="edit_code" class="form-control">
                                    </div>
                                </div>
                                  <div class="row col-md-12">
                                   <div class="col-md-12 form-group">
                ...
                <button id="save" class="btn btn-primary btn-sm" type="button" onclick="updateframe();"><i class="fas fa-plus-square"></i>Update</button>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Size/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'code' },
             { data: 'name' },
