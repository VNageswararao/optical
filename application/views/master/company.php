                            ...
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Company</a>
                                            </li>
                                            <li class="nav-item">
                             ...
                             <form id="company" action="#" method="post"> 
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="firstname">Code: <span class="text-danger">*</span></label>
                                ...
                                <div class="card-footer ml-auto">
                                    <button type="button" class="btn btn-success btn-min-width btn-glow mr-1 mb-1" onclick="savecompany();">Submit</button>
 ...
 <div id="company_modal" class="modal fade" role="dialog">
        ...
        <!-- Modal content-->
            <div class="modal-content">
                ...
                <button id="save" class="btn btn-primary btn-sm" type="button" onclick="updatecompany();"><i class="fas fa-plus-square"></i>Update</button>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Company/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'code' },
             { data: 'name' },
