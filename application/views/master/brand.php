...
?>      
                    ...
                    <div class="row match-height">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add Brand</a>
                                            </li>
                                            <li class="nav-item">
                       ...
                       <form id="classification" action="#" method="post"> 
                                ...
                                <div class="card-footer ml-auto">
                                    <button type="button" class="btn btn-success btn-min-width btn-glow mr-1 mb-1" onclick="classification('2');">Submit</button>
 ...
 <div id="classification_modal" class="modal fade" role="dialog">
        ...
        <!-- Modal content-->
            <div class="modal-content">
                        ...
                        <div class="col-lg-12 col-md-12" id="div_modal">
                                 <div class="row col-md-12">
                                   <div class="col-md-12 form-group">
                                         <label for="lastname">Code: <span class="text-danger">*</span></label>
                                         <input type="hidden" name="edit_classificationid" id="edit_classificationid">
                                         ...
                                         <input type="text" name="edit_code" id="edit_code" class="form-control" readonly>
                                    </div>
                                </div>
                                  <div class="row col-md-12">
                                   <div class="col-md-12 form-group">
                ...
                <button id="save" class="btn btn-primary btn-sm" type="button" onclick="updatedata();"><i class="fas fa-plus-square"></i>Update</button>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Brand/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'code' },
             { data: 'name' },
