                 ...
                 <section id="basic-tabs-components">
                    <div class="row match-height">
                        <div class="col-xl-12 col-lg-12">
                                ...
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="base-tab1" data-toggle="tab" aria-controls="tab1" href="#tab1" aria-expanded="true">Add HSN Master</a>
                                            </li>
                                            <li class="nav-item">
                            ...
                            <form id="Hsn_master" action="#" method="post"> 
                                <input type="hidden" name="csrf_test_name" id="csrf_test_name" value="<?php echo $this->security->get_csrf_hash(); ?>"> 
                                <div class="row">
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lastname">HSN Code: <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control"  id="hsn_code" name="hsn_code" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="lastname">Tax: <span class="text-danger">*</span></label>
...
$( document ).ready(function() {
   table= $('#tableid').DataTable( {
          'processing': true,
          'serverSide': true,
          'ajax':'<?=base_url()?>master/Hsn_master/ajax_call',
          'columns': [
             { data: 'slno' },
             { data: 'hsn_code' },
             { data: 'name' },
...
function savedata()
{
    if( $("#name").val()=='') {
        ...
        $("#overlay").fadeIn(300);
         $.ajax({
            type: "POST",
            url: 'Hsn_master/savedata',
            dataType: "json",
            data: $('#Hsn_master').serialize(),
         ...
         $.ajax({
            ...
            success: function(data){
               ...
               if(data.msg != ''){
                 ...
                 $('.modal-title').html('Edit Hsn_master');
              } else if(data.error != ''){
                Swal.fire({title:"Warning!",text:""+data.error+"",type:"warning",confirmButtonClass:"btn btn-primary",buttonsStyling:!1});
              } else if(data.error_message) 
              {
