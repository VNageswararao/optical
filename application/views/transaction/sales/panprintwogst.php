...
<table width="100%" style="font-size:12px;font-family:Verdana, Arial, Helvetica, sans-serif;margin-top:0%;border-collapse: collapse;border:0.6px solid black;height:100px;" border="0">
    ...
    <tr>
        <td style="width:75%;text-align:left;border:0.6px solid black;padding:10px;">
         ...
         <p><b>MR Number:<?=$mrd?>Address: </b><?=$customer_address?>  <b>Phone</b> :  <?=$customer_land_phone?></p>
...
<div style="margin-top:0%;">
  ...
  border-right: none;width:100%;">
        <tr style="border:0.6px solid black;background: #f5f5f5;">
           ...
           <th style="width:35%;border-right:0.6px solid black;">Product</th>
           <th style="width:5%;border-right:0.6px solid black;" align="center">Model</th>
           ...
           <th style="width:20%;border-right:0.6px solid black;"  align="center">Total Amount</th>
        </tr>
      ...
      <tr>
        ...
        <td style="border-right:0.6px solid black;" align="right"><?=number_format((float)$rate+$gstt,2,'.', '')?></td>
