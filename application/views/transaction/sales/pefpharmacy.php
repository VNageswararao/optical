...
<div style="border: 0px Solid  #000000;padding:5px 5px 5px 5px;font-weight: bold;">
 <table width="100%" style="font-size:13px;font-weight: bold;font-family:Verdana, Arial, Helvetica, sans-serif;margin-top:0%;border-collapse: collapse;border:0.6px solid black" border="0">
    <tr>
     
    	<td style="width:10%;">
    		<?php echo $logo; ?>
    	</td>
     <td style="width:90%;text-align:center;padding:10px;" valign="middle">
...
<div style="margin-top:0%;">
  <div style="font-family:Verdana, Arial, Helvetica, sans-serif;border:1px solid black;" >
     <table   style="font-size:10px;font-weight: bold;font-family:Verdana, Arial, Helvetica, sans-serif;margin-top:0%;border-collapse: collapse;border-left: none;
  border-right: none;width:100%;">
        <tr style="border:0.6px solid black;background: #f5f5f5;">
           ...
           <th style="width:10%;border-right:0.6px solid black;">HSN</th>
           <th style="width:25%;border-right:0.6px solid black;" align="center">Batch && Exp</th>
           <th style="width:9%;border-right:0.6px solid black;" align="center">Rate</th>
           <th style="width:6%;border-right:0.6px solid black;" align="center">Qty</th>
           <th style="width:8%;border-right:0.6px solid black;" align="center">GST%</th> 
           <th style="width:7%;border-right:0.6px solid black;" align="center">GST</th> 
      ...
      <tr>
         ...
         <td  style="padding-left:1%;text-align:left;border-right:0.6px solid black;"><?=$hsn?></td>
