<div style="border: 0px Solid  #000000;padding:5px 5px 5px 5px;">
 <table width="100%" style="font-size:14px;font-family:Verdana, Arial, Helvetica, sans-serif;margin-top:0%;border-collapse: collapse;border:0.6px solid black" border="0">
    <tr>
      <td style="width:5%;text-align:center;padding:8px;" valign="top">
        <?=$rvlogo?>
      </td>
    
     <td style="width:95%;text-align:center;padding:8px;" valign="top">
...
<div style="margin-top:0%;">
 ...
 ?>
    ...
    <tr>
        <th style="width:20%;text-align:center;">
         ...
         <th style="width:10%;text-align:center;display: none;">
          GST
        </th>
         <th style="width:20%;text-align:center;">
          Paid Amount
 ...
 <td style="text-align:center;display: none;"><?=number_format((float)$total_gst,2,'.', '')?></td>
