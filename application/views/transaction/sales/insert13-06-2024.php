				...
				<button type="button" id="mclose" class="btn btn-danger btn-sm stmlns" data-dismiss="modal">Close</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                     ...
                                     <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="lastname">Time: <span class="text-danger">*</span>
											<span style="cursor:pointer;"  class="notification-tag badge badge-danger float-right m-0" id="createlens" onclick="createlens();">Create Lens</span>
											</label>
