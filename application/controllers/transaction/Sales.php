...
public function addMasterDataRow(){
	...
	$tr_html.='<td><input type="text" name="itemname_'.$trlength.'" id="itemname_'.$trlength.'" class="form-control grid_table" value="'.$itemType.'" readonly=""></td>';
    ...
    /*$tr_html.='<td><input type="text" name="rate_'.$trlength.'" id="rate_'.$trlength.'" class="form-control grid_table" value=""></td>
                   <td><input type="number" step="any" name="quantity_'.$trlength.'" id="quantity_'.$trlength.'" class="form-control grid_table" value="0" required="" autocomplete="off"></td>
                   <td><input type="text" name="frametype_'.$trlength.'" id="frametype_'.$trlength.'" class="form-control grid_table" value=""></td>
                   <td><input type="text" name="color_'.$trlength.'" id="color_'.$trlength.'" class="form-control grid_table" value=""></td>
                   <td><input type="text" name="size_'.$trlength.'" id="size_'.$trlength.'" class="form-control grid_table" value=""></td>
                   <td><input type="text" name="model_'.$trlength.'" id="model_'.$trlength.'" class="form-control grid_table" value=""></td>
                   <td><input type="text" name="lenstype_'.$trlength.'" id="lenstype_'.$trlength.'" class="form-control grid_table" value=""></td>
                   <td><input type="text" name="coting_'.$trlength.'" id="coting_'.$trlength.'" class="form-control grid_table" value=""></td>
                    <td><input type="text" name="dtype_'.$trlength.'" id="dtype_'.$trlength.'" class="form-control grid_table" value=""></td>
					<td class="mbl_view">
                       <select name="discount_type[]" id="discount_type_'.$trlength.'" class="form-control grid_table">
                         <option value="0">Amount</option>
                         <option value="1">Percentage</option>
                       </select>
                   </td>
