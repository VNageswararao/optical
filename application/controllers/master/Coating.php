...
class Coating extends CI_Controller {
	...
	{
          $data['title']='Optical::Coating';
          $data['activecls']='coating';
          $content=$this->load->view('master/coating',$data,true);
	...
	public function savelens()
	{
		...
		$this->form_validation->set_rules('name', 'Coating Name', 'trim|required|min_length[1]|max_length[30]');
	    ...
	    if($this->form_validation->run() == TRUE)
	    {
	    	...
	    	{
	    		$this->msg='';
	    		  $this->error='Code and Coating Name already Used';
	    		  $this->error_message ='';
	              echo json_encode(array(
			        'msg'           => $this->msg,
			        'error'         => $this->error,
	...
	public function editlens()
	{
		...
		$this->form_validation->set_rules('edit_name', 'Coating Name', 'trim|required|min_length[1]|max_length[30]');
