...
class Colour extends CI_Controller {
	...
	{
          $data['title']='Optical::Colour';
          $data['activecls']='Colour';
      ...
      $data['codeno']=$code;
          $content=$this->load->view('master/colour',$data,true);
	...
	public function saveframe()
	{
		...
		$this->form_validation->set_rules('name', 'Colour', 'trim|required|min_length[1]|max_length[30]');
	    ...
	    if($this->form_validation->run() == TRUE)
	    {
	    	...
	    	{
	    		$this->msg='';
	    		  $this->error='Code and Colour already Used';
	    		  $this->error_message ='';
	              echo json_encode(array(
			        'msg'           => $this->msg,
			        'error'         => $this->error,
	...
	public function editframe()
	{
		...
		$this->form_validation->set_rules('edit_name', 'Colour', 'trim|required|min_length[1]|max_length[30]');
